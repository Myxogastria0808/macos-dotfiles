...
action "System Settings > Privacy & Security > Full Disk Access   → add Tailscale      (for network extension)"
action "System Settings > Privacy & Security > Full Disk Access   → add Visual Studio Code (for file access)"
